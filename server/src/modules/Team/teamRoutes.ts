...
import { addTeamMemberController, archiveTeamController, createTeamController, deleteTeamController, getOrganizationTeamsController, getTeamDetailsController, getTeamMembersController, leaveTeamController, removeTeamMemberController, restoreTeamController, transferTeamOwnershipController, updateTeamController, updateTeamMemberRoleController } from "./teamController.js";
...
router.delete("/:teamId",authMiddleware,organizationMiddleware,teamMiddleware,requireTeamPermission(teamPermission.DELETE_TEAM),deleteTeamController);
